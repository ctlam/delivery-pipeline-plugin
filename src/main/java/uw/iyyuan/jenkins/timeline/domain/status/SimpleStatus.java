...
*/
package uw.iyyuan.jenkins.timeline.domain.status;

import static java.lang.Math.round;
import static java.lang.System.currentTimeMillis;
import static uw.iyyuan.jenkins.timeline.domain.status.StatusType.CANCELLED;
import static uw.iyyuan.jenkins.timeline.domain.status.StatusType.DISABLED;
import static uw.iyyuan.jenkins.timeline.domain.status.StatusType.FAILED;
import static uw.iyyuan.jenkins.timeline.domain.status.StatusType.IDLE;
import static uw.iyyuan.jenkins.timeline.domain.status.StatusType.NOT_BUILT;
import static uw.iyyuan.jenkins.timeline.domain.status.StatusType.QUEUED;
import static uw.iyyuan.jenkins.timeline.domain.status.StatusType.RUNNING;
import static uw.iyyuan.jenkins.timeline.domain.status.StatusType.SUCCESS;
import static uw.iyyuan.jenkins.timeline.domain.status.StatusType.UNSTABLE;
...
import uw.iyyuan.jenkins.timeline.domain.AbstractItem;
import uw.iyyuan.jenkins.timeline.domain.status.promotion.AbstractPromotionStatusProvider;
