...
import uw.iyyuan.jenkins.timeline.sort.NameComparator;
...
public class DeliveryPipelineViewTest {
    ...
    public void testOldSorter() throws Exception {
        ...
        field.set(view, "uw.iyyuan.jenkins.timeline.sort.NoOpComparator");
        assertEquals("none", view.getSorting());

        view.setSorting("uw.iyyuan.jenkins.timeline.sort.NoOpComparator");
        assertEquals("none", view.getSorting());
    }
    ...
    public void testSetSorting() {
        DeliveryPipelineView view = new DeliveryPipelineView("name");
        view.setSorting("uw.iyyuan.jenkins.timeline.sort.NameComparator");
        assertEquals("uw.iyyuan.jenkins.timeline.sort.NameComparator", view.getSorting());
    }
